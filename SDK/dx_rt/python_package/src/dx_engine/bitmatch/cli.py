...
def main():
    ...
    parser.add_argument("--debug", type=bool, required=False, help="RT debug options, 0(defualt): Do not generate RT output binaries. / 1: Generate RT output binaries for debug.", default=False)
    ...
    parser.add_argument("--input-order", type=str, choices=["random", "sequential"], default="random",
                        help="Input index selection order (default: random)\n"
